          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Design dimensional model', description: 'Create star schema design', status: 'Completed', effort: 8 },
                { title: 'Set up cloud data warehouse', description: 'Provision Snowflake/BigQuery instance', status: 'Completed', effort: 5 },
                { title: 'Implement ETL pipelines', description: 'Build data ingestion workflows', status: 'In Progress', effort: 13 },
              ],
            },
            {
              ...
              workItems: [
                { title: 'Define data quality metrics', description: 'Establish quality KPIs', status: 'Completed', effort: 5 },
                { title: 'Build validation rules', description: 'Implement automated data checks', status: 'In Progress', effort: 8 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Evaluate BI tools', description: 'Compare Tableau, PowerBI, Looker', status: 'Completed', effort: 8 },
                { title: 'Deploy BI platform', description: 'Set up selected tool', status: 'In Progress', effort: 13 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Select API gateway solution', description: 'Evaluate Kong, Apigee, AWS Gateway', status: 'Completed', effort: 5 },
                { title: 'Deploy gateway infrastructure', description: 'Set up gateway in production', status: 'In Progress', effort: 13 },
                { title: 'Configure rate limiting', description: 'Implement throttling policies', status: 'Not Started', effort: 5 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[1].id],
              workItems: [
                { title: 'Set up docs framework', description: 'Configure Swagger/OpenAPI', status: 'Completed', effort: 8 },
                { title: 'Write API documentation', description: 'Document all endpoints', status: 'In Progress', effort: 21 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[0].id],
              workItems: [
                { title: 'Design checkout UI', description: 'Create streamlined checkout design', status: 'Completed', effort: 8 },
                { title: 'Implement payment tokenization', description: 'Store payment methods securely', status: 'Completed', effort: 13 },
                { title: 'Build one-click flow', description: 'Implement express checkout logic', status: 'Completed', effort: 13 },
                { title: 'Testing and QA', description: 'Comprehensive checkout testing', status: 'In Progress', effort: 8 },
              ],
            },
            {
              ...
              tier3Assignments: [tier3Units[1].id],
              workItems: [
                { title: 'Remove unnecessary form fields', description: 'Minimize required information', status: 'Completed', effort: 5 },
                { title: 'Implement autofill support', description: 'Add browser autofill', status: 'Completed', effort: 8 },
                { title: 'Guest order tracking', description: 'Allow tracking without account', status: 'In Progress', effort: 8 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[2].id],
              workItems: [
                { title: 'Collect training data', description: 'Gather historical purchase data', status: 'Completed', effort: 8 },
                { title: 'Train recommendation model', description: 'Build collaborative filtering model', status: 'In Progress', effort: 21 },
                { title: 'A/B testing framework', description: 'Set up recommendation testing', status: 'Not Started', effort: 13 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[3]?.id || tier3Units[0].id],
              workItems: [
                { title: 'Mobile UI design', description: 'Create mobile-optimized layouts', status: 'Completed', effort: 13 },
                { title: 'Image optimization', description: 'Implement responsive images', status: 'Completed', effort: 8 },
                { title: 'Mobile product page implementation', description: 'Build mobile product views', status: 'In Progress', effort: 13 },
                { title: 'Performance optimization', description: 'Achieve <2s load time', status: 'Not Started', effort: 8 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[1].id],
              workItems: [
                { title: 'Configure CI server', description: 'Set up Jenkins/GitLab CI', status: 'Completed', effort: 8 },
                { title: 'Create build pipelines', description: 'Automate build process', status: 'Completed', effort: 13 },
                { title: 'Implement deployment automation', description: 'Automated deploy to environments', status: 'In Progress', effort: 13 },
                { title: 'Add automated testing', description: 'Integrate test suites in pipeline', status: 'In Progress', effort: 13 },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[2].id],
              workItems: [
                { title: 'Select IaC tool', description: 'Evaluate Terraform vs alternatives', status: 'Completed', effort: 5 },
                { title: 'Define infrastructure modules', description: 'Create reusable IaC modules', status: 'Completed', effort: 13 },
                { title: 'Migrate existing infrastructure', description: 'Convert manual configs to code', status: 'In Progress', effort: 21 },
                { title: 'Set up state management', description: 'Configure remote state backend', status: 'Not Started', effort: 8 },
              ],
            },
          ],
        },
