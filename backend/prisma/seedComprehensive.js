          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Design dimensional model', description: 'Create star schema design', status: 'Completed', priority: 'P1' },
                { title: 'Set up cloud data warehouse', description: 'Provision Snowflake/BigQuery instance', status: 'Completed', priority: 'P1' },
                { title: 'Implement ETL pipelines', description: 'Build data ingestion workflows', status: 'In Progress', priority: 'P2' },
              ],
            },
            {
              ...
              workItems: [
                { title: 'Define data quality metrics', description: 'Establish quality KPIs', status: 'Completed', priority: 'P2' },
                { title: 'Build validation rules', description: 'Implement automated data checks', status: 'In Progress', priority: 'P2' },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Evaluate BI tools', description: 'Compare Tableau, PowerBI, Looker', status: 'Completed', priority: 'P1' },
                { title: 'Deploy BI platform', description: 'Set up selected tool', status: 'In Progress', priority: 'P1' },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              workItems: [
                { title: 'Select API gateway solution', description: 'Evaluate Kong, Apigee, AWS Gateway', status: 'Completed', priority: 'P1' },
                { title: 'Deploy gateway infrastructure', description: 'Set up gateway in production', status: 'In Progress', priority: 'P1' },
                { title: 'Configure rate limiting', description: 'Implement throttling policies', status: 'Not Started', priority: 'P2' },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[1].id],
              workItems: [
                { title: 'Set up docs framework', description: 'Configure Swagger/OpenAPI', status: 'Completed', priority: 'P2' },
                { title: 'Write API documentation', description: 'Document all endpoints', status: 'In Progress', priority: 'P2' },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[0].id],
              workItems: [
                { title: 'Design checkout UI', description: 'Create streamlined checkout design', status: 'Completed' },
                { title: 'Implement payment tokenization', description: 'Store payment methods securely', status: 'Completed' },
                { title: 'Build one-click flow', description: 'Implement express checkout logic', status: 'Completed' },
                { title: 'Testing and QA', description: 'Comprehensive checkout testing', status: 'In Progress' },
              ],
            },
            {
              ...
              tier3Assignments: [tier3Units[1].id],
              workItems: [
                { title: 'Remove unnecessary form fields', description: 'Minimize required information', status: 'Completed' },
                { title: 'Implement autofill support', description: 'Add browser autofill', status: 'Completed' },
                { title: 'Guest order tracking', description: 'Allow tracking without account', status: 'In Progress' },
              ],
            },
          ],
        },
          ...
          childObjectives: [
            {
              ...
              tier3Assignments: [tier3Units[2].id],
              workItems: [
                { title: 'Collect training data', description: 'Gather historical purchase data', status: 'Completed' },
                { title: 'Train recommendation model', description: 'Build collaborative filtering model', status: 'In Progress' },
                { title: 'A/B testing framework', description: 'Set up recommendation testing', status: 'Not Started' },
              ],
            },
          ],
        },
